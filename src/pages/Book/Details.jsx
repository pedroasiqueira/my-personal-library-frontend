  ...
  return (
    <div className="min-h-screen px-4 py-8 max-w-2xl mx-auto">
      ...
      <div className="bg-white shadow-md rounded-xl p-6 space-y-4">
        ...
        <p className="text-gray-600">Data de início: {book.startDate}</p>
        {book.endDate && <p className="text-gray-600">Data de término: {book.endDate}</p>}
      ...
      <div className="mt-6">
  <h2 className="text-lg font-semibold text-gray-800 mb-2">Comentários</h2>
